        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-xs-6 block-rel">
                    <h3>Relatórios v.4</h3>
                    <p>Informe abaixo o tipo de relatório a ser gerado:</p>
                    <form class="j-form-rel" method="POST" action="">
                        ...
                        <input type="text" class="j-date form-control col-md-2" name="dataIni">
                        <input type="text" class="j-date form-control col-md-2" name="dataFim">
                        <div class="j-add-el col-md-6">
                        </div>                        
